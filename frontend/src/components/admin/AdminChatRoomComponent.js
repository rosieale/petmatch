  ...
  return (
    <>
      <Toast show={toast1} onClose={close1} className="ms-4 mb-5">
        <Toast.Header>
          <strong className="me-auto">Chatear con John Doe</strong>
        </Toast.Header>
        <Toast.Body>
            ...
            {Array.from({ length: 30 }).map((_, idx) => (
              <Fragment key={idx}>
                <p className="bg-primary p-3 ms-4 text-light rounded-pill">
                  <b>Usuario escribió:</b> Hello, world! This is a chat message.
                </p>
                <p>
                  <b>Admin escribió:</b> Hello, world! This is a chat message.
                </p>
              </Fragment>
            ))}
          </div>
      ...
      <Toast show={toast2} onClose={close2} className="ms-4 mb-5">
        <Toast.Header>
          <strong className="me-auto">Chatear con John Doe2</strong>
        </Toast.Header>
        <Toast.Body>
          <div style={{ maxHeight: "500px", overflow: "auto" }}>
            {Array.from({ length: 30 }).map((_, idx) => (
